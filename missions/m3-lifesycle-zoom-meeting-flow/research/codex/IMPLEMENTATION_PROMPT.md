...
Ortak araştırma referansı: `SHARED_RESEARCH_REPORT.md`. Lifesycle domain modeli public kaynaklarda sınırlı olduğu için aşağıdaki entity'ler mission brief'lerinden çıkarılmış varsayımlardır.
