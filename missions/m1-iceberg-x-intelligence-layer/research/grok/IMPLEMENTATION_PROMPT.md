...
Ortak araştırma referansı: `SHARED_RESEARCH_REPORT_grok.md`. Özellikle OpenProject, Plane, Taiga, Kanboard, LangGraph, OpenAI Agents SDK ve MCP bulgularını kullan.
