...
Ortak araştırma referansı: `SHARED_RESEARCH_REPORT_grok.md`. OpenAI Agents SDK, MCP, LangGraph, CrewAI, Aider, Continue ve Cursor/agent workflow bulgularını kullan.
